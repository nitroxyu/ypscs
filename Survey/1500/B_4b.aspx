<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B_4b.aspx.cs" Inherits="Survey_1500_B_4b" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q205" runat="server" />若貴公司自洽運輸車輛或船舶，請從4b.5開始作答。</span> </td>
                    </tr>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q206" runat="server" />若貴公司為<span class="SurveyUnderline">外銷客戶</span>，則免填4b.2、4b.6此二項。</span> </td>
                    </tr>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q207" runat="server" />若貴公司為<span class="SurveyUnderline">內銷客戶</span>，則免填4b.3此項。</span> </td>
                    </tr>
                    <tr>
                                ...
                                <blockquote>
                                   <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline"> YP洽運之運輸公司服務</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:DropDownList ID="Q216" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q217_0" runat="server" GroupName="Q217" onclick="radiocheck(this);" /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">其他:</span><asp:TextBox ID="Q220" runat="server"></asp:TextBox></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="11">
                                                <table  class="SurveyQuestion">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>編號：<asp:TextBox ID="Q226" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q227" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>需要<span class="SurveyUnderlineBold">改善</span>部分之</td>
                                                        <td>編號：<asp:TextBox ID="Q228" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q229" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q230_1" GroupName="Q230" onclick="radiocheck(this);" runat="server" />常發生&nbsp;&nbsp;<asp:RadioButton ID="Q230_2" GroupName="Q230" onclick="radiocheck(this);" runat="server" />偶爾發生</td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td>編號：<asp:TextBox ID="Q231" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q232" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q233_1" GroupName="Q233" onclick="radiocheck(this);" runat="server" />常發生&nbsp;&nbsp;<asp:RadioButton ID="Q233_2" GroupName="Q233" onclick="radiocheck(this);" runat="server" />偶爾發生</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
