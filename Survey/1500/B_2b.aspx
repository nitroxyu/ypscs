<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B_2b.aspx.cs" Inherits="Survey_1500_B_2b" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q74" runat="server" />無購買烤漆產品，則免填寫2b.部份</span> </td>
                    </tr>
                    <tr>
                                ...
                                <blockquote>
                                    <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">提供之烤漆產品保固年限</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">提供之烤漆產品保固項目(不穿孔、塗膜完整性、塗膜附著性、不粉化)</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">其他:</span><asp:TextBox ID="Q87" runat="server"></asp:TextBox></td>
                                            <td></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="11">
                                                <table class="SurveyQuestion">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>編號：<asp:TextBox ID="Q93" runat="server" Style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q94" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>需要<span class="SurveyUnderlineBold">改善</span>部分之</td>
                                                        <td>編號：<asp:TextBox ID="Q95" runat="server" Style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q96" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q97_1" GroupName="Q97" onclick="radiocheck(this);" runat="server" />常發生&nbsp;&nbsp;<asp:RadioButton ID="Q97_2" GroupName="Q97" onclick="radiocheck(this);" runat="server" />偶爾發生</td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td>編號：<asp:TextBox ID="Q98" runat="server" Style="width: 30px;"></asp:TextBox></td>
                                                        <td>說明：</td>
                                                        <td>
                                                            <asp:TextBox ID="Q99" runat="server" Width="300px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q100_1" GroupName="Q100" onclick="radiocheck(this);" runat="server" />常發生&nbsp;&nbsp;<asp:RadioButton ID="Q100_2" GroupName="Q100" onclick="radiocheck(this);" runat="server" />偶爾發生</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
