<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="D.aspx.cs" Inherits="Survey_1500_D" StylesheetTheme="Base" %>
            ...
            <td>
                <asp:Panel ID="Panel_Ans" runat="server">
                    <table>
                                ...
                                <blockquote>
                                    <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2016)年度貴公司採購燁輝鋼品的<span class="SurveyUnderline">整體滿意程度</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2016)年度燁輝公司為貴 公司<span class="SurveyUnderline">所創造或提升價值之滿意程度</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2016)年度對燁輝公司<span class="SurveyUnderline">整體滿意度「相對其他供應商比較」之滿意度</span></td>
                                            <td>
                        ...
                        <tr>
                            <td><span class="SurveyQuesLargeBold">2016對燁輝是否有其他建議?
