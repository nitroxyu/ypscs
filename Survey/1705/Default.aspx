<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Survey_1705_Default" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: right" class="SurveyDescription">Project Director: D.J. Yang, Ph.D.<br />
                            Research Survey Center, I-Shou University, Taiwan<br />11/09/2018</td>
                    </tr>
                </table>
            </td>
        </tr>
