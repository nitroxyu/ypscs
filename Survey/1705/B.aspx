<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="B.aspx.cs" Inherits="Survey_1705_B" StylesheetTheme="Base" %>
    ...
    <table style="width: 100%">
        <tr>
            <td>
                <table>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">B. Evaluation of Shin Yang's performance</span></td>
                    </tr>
                    <tr>
                        <td>
                            <blockquote>
                                <table class="SurveyNormal" style="border: 1px solid">
                                    <tr>
                                        <td>
                                            ...
                                            <p>Shin Yang's performances are comprised of eight categories: sales services, product mix, product quality, product delivery, after-sales services, complaint/claim handling, product development and information services. Please assess the importance of each category and your satisfaction with Shin Yang’s performance for each one.</p>
                                            ...
                                            <span style="text-decoration: underline;"><span style="font-weight: bold">Satisfaction</span></span> with Shin Yang’s performance:
                                           <blockquote>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                                ...
                                                <tr>
                                                    <td><span style="text-decoration: underline;">Shin Yang’s sales service</span></td>
                                                    <td>
                                                        ...
                                                        <td colspan="11">
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: top;">No.:<input id="Text5" type="text" style="width: 30px;" readonly="readonly" value="1.3" /></td>
                                                                    <td style="vertical-align: top;">For example:</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="SurveyQuestion">
                                                                        <input id="Checkbox1" type="radio" onclick="this.checked = false;" />Often happens<br /><input id="Checkbox2" type="radio" checked="checked" onclick="this.checked = true;" />Sometimes happens</td>
                                                                </tr>
                                                                <tr>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3"></td>
                                                                    <td class="SurveyQuestion">
                                                                        <input id="Checkbox3" type="radio" onclick="this.checked = false;" />Often happens<br /><input id="Checkbox4" type="radio" onclick="this.checked = false;" />Sometimes happens</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
