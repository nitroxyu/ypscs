<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Survey_1502_Default" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: right" class="SurveyDescription">Project Director: D.J. Yang, Ph.D.<br />
                            Research Survey Center, I-Shou University, Taiwan<br />11/01/2016</td>
                    </tr>
                </table>
            </td>
        </tr>
