<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="A.aspx.cs" Inherits="Survey_1502_A" StylesheetTheme="Base" %>
                                            ...
                                            <td>Number of years as YIEH PHUI's business partner:<br />
                                                <table>
                                                    <tr>
                                                        ...
                                                        <asp:RadioButton ID="Q23_2" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />1~3 years&nbsp;&nbsp;
