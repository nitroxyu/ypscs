...
public partial class Survey_1502_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string[] pagename = new string[] { "A.aspx", "B.aspx", "B_1.aspx", "B_2a.aspx", "B_2b.aspx", "B_3.aspx"
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1502/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1502/" + pagename[x] + "?svid=" + svid);
