...
public partial class Survey_1505_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1505/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1505/" + pagename[x] + "?svid=" + svid);
