...
public partial class Survey_1505_D : System.Web.UI.Page
{
    int seqs =305;
    int seqe = 311;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1505", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (!Q310_0.Checked && !Q310_1.Checked)
            this.PopupMessage1.Add("Field Do you have revised the last year answers must select");
        else if (Q310_1.Checked && String.IsNullOrEmpty(Q311.Text))
            this.PopupMessage1.Add("Field suggestions must input");
