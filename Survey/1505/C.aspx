<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="C.aspx.cs" Inherits="Survey_1505_C" StylesheetTheme="Base" %>
                                        ...
                                        <tr>
                                            <td class="SurveyRadioColumn">Please select the top five most important factors from the following list which are essential for steel supplier selection, starting from the most important to least important.<br />
                                               <span class="SurveyUnderline"> Factors: </span>
                                                ...
                                                Rank of importance:<asp:TextBox ID="Q303_1" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q303_2" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q303_3" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q303_4" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q303_5" runat="server" Width="50px"></asp:TextBox>
                                                <br />O. Others：<asp:TextBox ID="Q304" runat="server"></asp:TextBox> (Please specify.)
