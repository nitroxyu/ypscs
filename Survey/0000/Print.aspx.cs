...
public partial class Survey_0000_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string site = "http://ypscs.apphb.com";
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/0000/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/0000/" + pagename[x] + "?svid=" + svid);
