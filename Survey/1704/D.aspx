<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="D.aspx.cs" Inherits="Survey_1704_D" StylesheetTheme="Base" %>
            ...
            <td>
                <asp:Panel ID="Panel_Ans" runat="server">
                    <table>
                                ...
                                <blockquote>
                                    <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2017)年度貴公司採購鑫陽鋼管的<span class="SurveyUnderline">整體滿意程度</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2017)年度鑫陽鋼管為貴 公司<span class="SurveyUnderline">所創造或提升價值</span>之滿意程度</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion">本(2017)年度對鑫陽鋼管<span class="SurveyUnderline">整體滿意度</span>「相對其他供應商比較」之滿意度</td>
                                            <td>
                        ...
                        <tr>
                            <td><span class="SurveyQuesLargeBold">2017對鑫陽鋼管是否有其他建議?
