<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="B.aspx.cs" Inherits="Survey_1704_B" StylesheetTheme="Base" %>
    ...
    <table style="width: 100%">
        <tr>
            <td>
                <table>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">貮、鑫陽表現評價</span></td>
                    </tr>
                    <tr>
                        <td>
                            <blockquote>
                                <table class="SurveyNormal" style="border: 1px solid">
                                    <tr>
                                        <td>
                                            ...
                                            <p>茲將鑫陽的表現區分成銷售服務、產品組合、產品品質、產品交運、售後服務、客訴處理、產品開發、資訊服務等八大類因素，敬請　貴公司評價八大類因素的重要程度。另外，各大類因素都有數項品質個題，並將品質滿意度區分八級水準；再請　貴公司逐題表達真實的滿意水準。若有特別意見，亦請不吝隨題提供。</p>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                                ...
                                                <tr>
                                                    <td><span style="text-decoration: underline;">鑫陽銷售服務</span></td>
                                                    <td>
                                                    ...
                                                    <td colspan="11">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>編號：<input id="Text5" type="text" style="width: 30px;" readonly="readonly" value="1.3" /></td>
                                                                <td>說明：</td>
                                                                <td>
                                                                    <input id="Text6" type="text" readonly="readonly" value="訂單交貨期準確性待加強" style="width: 300px" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3"></td>
                                                                <td class="SurveyQuestion">
                                                                    <input id="Checkbox1" type="radio" onclick="this.checked = false;" />常發生&nbsp;&nbsp;<input id="Checkbox2" type="radio" onclick="    this.checked = false;" />偶爾發生</td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                            ...
                                                            <tr>
                                                                <td colspan="3"></td>
                                                                <td class="SurveyQuestion">
                                                                    <input id="Checkbox3" type="radio" onclick="this.checked = false;" />常發生&nbsp;&nbsp;<input id="Checkbox4" type="radio" onclick="    this.checked = false;" />偶爾發生</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
