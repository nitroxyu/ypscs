<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="A.aspx.cs" Inherits="Survey_1700_A" StylesheetTheme="Base" %>
                ...
                <table>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">壹、填答人背景</span> <span class="SurveyQuesLarge">(務必填寫，以利本中心聯繫請教，謝謝)</span>
                            <blockquote class="SurveyQuesLarge" style="color: red;">如需修改已填資料，請輸入先前填寫E-mail,再按"載入紀錄"<br />如需匯入去年填寫資料，請輸入先前填寫E-mail，再按"載入紀錄"</blockquote>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                            ...
                                            <td>貴公司在鋼品上與燁輝之業務往來時間是：<br />
                                                <table>
                                                    <tr>
                                                        ...
                                                        <asp:RadioButton ID="Q23_2" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />1~5年&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_3" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />6~10年&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_4" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />11~15年&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_5" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />16~19年&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_6" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />20年以上&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
