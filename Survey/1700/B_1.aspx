<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B_1.aspx.cs" Inherits="Survey_1700_B_1" StylesheetTheme="Base" %>
                                            ...
                                            <td colspan="11">
                                                <table  class="SurveyQuestion">
                                                    ...
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q48_1" GroupName="Q48" onclick="radiocheck(this);" runat="server" />常發生&nbsp;&nbsp;<asp:RadioButton ID="Q48_2" GroupName="Q48" onclick="radiocheck(this);" runat="server" />偶爾發生</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
