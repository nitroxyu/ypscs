...
public partial class Survey_1700_D : System.Web.UI.Page
{
    int seqs = 311;
    int seqe = 315;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1700", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (!Q314_0.Checked && !Q314_1.Checked)
            this.PopupMessage1.Add("欄位 去年答案是否有進行修改 必需選擇");
        else if (Q314_1.Checked && String.IsNullOrEmpty(Q315.Text))
            this.PopupMessage1.Add("欄位 其他建議 必需輸入");
