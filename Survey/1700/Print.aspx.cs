...
public partial class Survey_1700_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        , "B_4a.aspx", "B_4b.aspx", "B_5.aspx", "B_6.aspx", "B_7.aspx", "C.aspx", "D.aspx"};

        System.Net.WebClient wc = new System.Net.WebClient();
        string datestr = DateTime.Today.ToString("yyyyMMdd");
        string site = Request.Url.Scheme + "://" + Request.Url.Authority;
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1700/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1700/" + pagename[x] + "?svid=" + svid);
