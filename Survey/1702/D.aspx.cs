...
public partial class Survey_1702_D : System.Web.UI.Page
{
    int seqs = 298;
    int seqe = 304;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1702", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (!Q303_0.Checked && !Q303_1.Checked)
            this.PopupMessage1.Add("Field Do you have revised the last year answers must select");
        else if (Q303_1.Checked && String.IsNullOrEmpty(Q304.Text))
