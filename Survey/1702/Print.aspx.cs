...
public partial class Survey_1702_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1702/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1702/" + pagename[x] + "?svid=" + svid);
