<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B.aspx.cs" Inherits="Survey_1701_B" StylesheetTheme="Base" %>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="SurveyQuestion">
                                                                        <input id="Checkbox1" type="radio" onclick="this.checked = false;" />Often happens&nbsp;&nbsp;<input id="Checkbox2" type="radio" checked="checked" onclick="this.checked = true;" />Sometimes happens</td>
                                                                </tr>
                                                                <tr>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3"></td>
                                                                    <td class="SurveyQuestion">
                                                                        <input id="Checkbox3" type="radio" onclick="this.checked = false;" />Often happens&nbsp;&nbsp;<input id="Checkbox4" type="radio" onclick="this.checked = false;" />Sometimes happens</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
