<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="C.aspx.cs" Inherits="Survey_1701_C" StylesheetTheme="Base" %>
                                    ...
                                    <table style="width: 100%; border-spacing: 0px; text-align: left;">
                                        <tr>
                                            <td class="SurveyRadioColumn">Please select the top five most important factors from the following list which are essential for steel supplier selection, starting from the most important to least important.<br />
                                                ...
                                                Rank of importance:<asp:TextBox ID="Q296_1" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q296_2" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q296_3" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q296_4" runat="server" Width="50px"></asp:TextBox>＞<asp:TextBox ID="Q296_5" runat="server" Width="50px"></asp:TextBox>
                                                <br />O. Others：<asp:TextBox ID="Q297" runat="server"></asp:TextBox> (Please specify.)
