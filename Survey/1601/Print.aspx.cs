...
public partial class Survey_1601_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string[] pagename = new string[] { "A.aspx", "B.aspx", "B_1.aspx", "B_2.aspx"
           , "B_3a.aspx" , "B_3b.aspx" , "B_3c.aspx" , "B_3d.aspx" , "B_3e.aspx" , "B_3f.aspx"
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1601/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1601/" + pagename[x] + "?svid=" + svid);
