...
public partial class Survey_1601_D : System.Web.UI.Page
{
    int seqs = 335;
    int seqe = 341;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1601", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (Q340_1.Checked && String.IsNullOrEmpty(Q341.Text))
