<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="D.aspx.cs" Inherits="Survey_1504_D" StylesheetTheme="Base" %>
                    ...
                    <table>
                                ...
                                <blockquote>
                                    <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButton ID="Q314_6" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_5" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_4" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_3" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_2" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_1" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_7" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_8" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                            <td>
                                                <asp:RadioButton ID="Q314_0" runat="server" GroupName="Q314" onclick="radiocheck(this);" /></td>
                                        </tr>
                        ...
                        <tr>
                            <td><span class="SurveyQuesLargeBold">去年答案是否有進行修改?
                                <asp:RadioButton ID="Q315_0" runat="server" GroupName="Q315" onclick="radiocheck(this);" Checked="true" />是，有進行修改；
                                <asp:RadioButton ID="Q315_1" runat="server" GroupName="Q315" onclick="radiocheck(this);" />否，答案與去年全部相同(須填寫最後一題)。</span> </td>
                        </tr>
                        <tr>
                            <td><span class="SurveyQuesLargeBold">2016對鑫陽鋼管是否有其他建議?
                                <asp:TextBox ID="Q316" runat="server" Width="250px"></asp:TextBox></span> </td>
                        </tr>
                    </table>
                </asp:Panel>
            </td>
