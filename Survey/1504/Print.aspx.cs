...
public partial class Survey_1504_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1504/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1504/" + pagename[x] + "?svid=" + svid);
