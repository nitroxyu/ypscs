<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="B_3e.aspx.cs" Inherits="Survey_1504_B_3e" StylesheetTheme="Base" %>
                                   ...
                                   <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:DropDownList ID="Q128" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q129_0" runat="server" GroupName="Q129" onclick="radiocheck(this);" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class="SurveyQuestion">(3)<span class="SurveyUnderline">角弧度</span></td>
                                            <td><asp:DropDownList ID="Q130" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q131_0" runat="server" GroupName="Q131" onclick="radiocheck(this);" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class="SurveyQuestion">(4)<span class="SurveyUnderline">平坦度</span></td>
                                            <td><asp:DropDownList ID="Q132" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q133_6" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_5" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_4" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_3" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_2" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_1" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_7" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_8" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q133_0" runat="server" GroupName="Q133" onclick="radiocheck(this);" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class="SurveyQuestion">(5)<span class="SurveyUnderline">扭曲度</span></td>
                                            <td><asp:DropDownList ID="Q134" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q135_6" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_5" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_4" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_3" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_2" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_1" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_7" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_8" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q135_0" runat="server" GroupName="Q135" onclick="radiocheck(this);" /></td>
                                        </tr>
                                        <tr>
                                            <td class="SurveyQuestion">3e.3</td>
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">鋼材加工性或成形性</span></td>
                                            <td><asp:DropDownList ID="Q136" runat="server">
                                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                                            <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                            <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                            ...
                                            <td><asp:RadioButton ID="Q137_6" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_5" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_4" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_3" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_2" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_1" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_7" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_8" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                            <td><asp:RadioButton ID="Q137_0" runat="server" GroupName="Q137" onclick="radiocheck(this);" /></td>
                                        </tr>
                                    </table>
