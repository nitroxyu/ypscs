<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage_Base.master" AutoEventWireup="true" CodeFile="B_3c.aspx.cs" Inherits="Survey_1504_B_3c" StylesheetTheme="Base" %>
    ...
    <table style="width: 100%">
        <tr>
            <td>
                <table>
                    <tr>
                        <td><span class="SurveyQuesLargeBold"><span class="SurveyUnderline">3c.後熱浸鍍鋅鋼管(白管)</span></span> </td>
                    </tr>
                    <tr>
                            ...
                            <asp:Panel ID="Panel_Ans" runat="server">
                                <blockquote>
                                   <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class="SurveyQuestion">(1)<span class="SurveyUnderline">直度</span></td>
