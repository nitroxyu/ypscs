...
public partial class Survey_1504_D : System.Web.UI.Page
{
    int seqs = 312;
    int seqe = 316;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1504", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (!Q315_0.Checked && !Q315_1.Checked)
            this.PopupMessage1.Add("欄位 去年答案是否有進行修改 必需選擇");
        else if (Q315_1.Checked && String.IsNullOrEmpty(Q316.Text))
