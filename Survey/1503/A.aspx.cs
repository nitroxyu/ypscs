...
public partial class Survey_1503_A : System.Web.UI.Page
{
    ...
    private void CheckInput()
    {
        ...
        if (String.IsNullOrEmpty(this.Q4.Text))
            this.PopupMessage1.Add("Filed Company name must be input");
        if (String.IsNullOrEmpty(this.Q2.Text))
            this.PopupMessage1.Add("Filed E-mail must be input");
    }
