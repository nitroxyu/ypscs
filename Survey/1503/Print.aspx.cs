...
public partial class Survey_1503_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.IO.Stream objStream = wc.OpenRead(site + "/Survey/1503/Default.aspx");
        ...
        {
            objStream = wc.OpenRead(site + "/Survey/1503/" + pagename[x] + "?svid=" + svid);
