...
public partial class Survey_1703_D : System.Web.UI.Page
{
    int seqs = 340;
    int seqe = 346;
    DataTable dtq;
    ...
    {
        dtq = YPSCS.Class.Survey.LoadQuestion("1703", seqs, seqe);
    ...
    private void CheckInput()
    {
        ...
        else if (!Q345_0.Checked && !Q345_1.Checked)
            this.PopupMessage1.Add("Field Do you have revised the last year answers must select");
        else if (Q345_1.Checked && String.IsNullOrEmpty(Q346.Text))
