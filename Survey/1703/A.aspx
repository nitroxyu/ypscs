<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="A.aspx.cs" Inherits="Survey_1703_A" StylesheetTheme="Base" %>
                ...
                <table>
                    <tr>
                        <td><span class="SurveyQuesLargeBold">A. Respondent's information</span> <span class="SurveyQuesLarge">(Please fill in <span class="SurveyQuesLargeBold">ALL</span> items below in case further contact is needed.)</span>
                            <blockquote class="SurveyQuesLarge" style="color: red;">If you want to refine or modify your answer, please fill your email address and enter the "Load Record" button.<br />If you want to load the last year answers in the questionnaire, please fill your email address and enter the "Load Record" button.</blockquote>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                            ...
                                            <td>Number of years as YIEH PHUI's business partner:<br />
                                                <table>
                                                    <tr>
                                                        ...
                                                        <asp:RadioButton ID="Q23_2" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />1~5 years&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_3" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />6~10 years&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_4" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />11~15 years&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_5" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />16~19 years&nbsp;&nbsp;
                                                        <asp:RadioButton ID="Q23_6" runat="server" GroupName="Q23" rdvalue="" onclick="radiocheck(this);" />20 years and over&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
