<%@ Page Title="" Language="C#" MasterPageFile="~/Survey/MasterPage.master" AutoEventWireup="true" CodeFile="B_4b.aspx.cs" Inherits="Survey_1703_B_4b" StylesheetTheme="Base" %>
                ...
                <table>
                    ...
                    <tr>
                        <td><span class="SurveyQuesLargeBold">
                            <asp:CheckBox ID="Q205" runat="server" />If your company books your own vessel space, please skip Item 4b.1-4b.3.</span> </td>
                    </tr>
                    <tr>
                                ...
                                <blockquote>
                                   <table style="width: 100%; border-spacing: 0px; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="SurveyQuestion"><span class="SurveyUnderline">Overall satisfaction</span><asp:TextBox ID="Q214" runat="server"></asp:TextBox></td>
                                            <td></td>
                                            ...
                                            <td colspan="11">
                                                <table  class="SurveyQuestion">
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top;">No.:<asp:TextBox ID="Q217" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td style="vertical-align: top;">For example:</td>
                                                        <td>
                                                            <asp:TextBox ID="Q218" runat="server" Width="300px" Rows="2" TextMode="MultiLine"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top;">No.:<asp:TextBox ID="Q221" runat="server" style="width: 30px;"></asp:TextBox></td>
                                                        <td style="vertical-align: top;">For example:</td>
                                                        <td>
                                                            <asp:TextBox ID="Q222" runat="server" Width="300px" Rows="2" TextMode="MultiLine"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q223_1" GroupName="Q223" onclick="radiocheck(this);" runat="server" />Often happens&nbsp;&nbsp;<asp:RadioButton ID="Q223_2" GroupName="Q223" onclick="radiocheck(this);" runat="server" />Sometimes happens</td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td class="SurveyQuestion">
                                                            <asp:RadioButton ID="Q226_1" GroupName="Q226" onclick="radiocheck(this);" runat="server" />Often happens&nbsp;&nbsp;<asp:RadioButton ID="Q226_2" GroupName="Q226" onclick="radiocheck(this);" runat="server" />Sometimes happens</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
